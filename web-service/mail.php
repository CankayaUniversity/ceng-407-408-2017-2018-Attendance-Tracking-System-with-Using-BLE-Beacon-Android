...
function send_register_validation_mail($to, $name, $surname, $token){
$mail = new PHPMailer();
$mail->IsSMTP();
$mail->SMTPAuth = true;
$mail->Host = 'smtp.attendancesystem.xyz';
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="emailContainer" style="font-family:Arial; color: #333333;">
                ...
                <tr>
                    ...
                    <td align="left" valign="top" colspan="2" style="border-bottom: 1px solid #CCCCCC; padding: 20px 0 10px 0;">
                        ...
                        <span style="font-size: 18px; font-weight: normal;">ACCOUNT ACTIVATION</span>
                ...
                <tr>
                    ...
                    <td align="left" valign="top" colspan="2" style="padding-top: 10px;">
						...
						Dear '.$name.' '.$surname.'<br/><br/>
                            ...
                            We have sent you this email to validate your e-mail account to use Attendance Tracking System.

                            <br/><br/>

                            To activate your account for Attendance Tracking System, please follow the link below:<br/>
							
                            <a href="http://attendancesystem.xyz/attendancetracking/activation.php?mail='.$secure_mail.'&token='.$token.'">Link</a>

                            <br/><br/>
							If your browser does not support this link, please copy the token below and enter it from the web page below.
							<br/>
							Token :  '.$token.'<br/>
							<a href="http://attendancesystem.xyz/attendancetracking/activation.php">Link</a>
